...
class ImageJointReconsEngine(Engine):
    ...
    def __init__(
        ...
        super(ImageJointReconsEngine, self
    ...
    def train(
        ...
        for batch_idx, data in enumerate(self.train_loader):
            ...
            loss_recons = self.criterion_mse(recons, imgs)
            loss = self.weight_t * loss_t + self.weight_x * loss_x  + self.weight_r*loss_recons
            loss.backward()
            self.optimizer.step()
