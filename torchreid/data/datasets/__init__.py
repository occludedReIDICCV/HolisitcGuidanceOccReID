...
from .image import Market1501, DukeMTMCreID, MSMT17,OccludedDukeMTMCreID,Paritial_REID,Occluded_REID,Market1501_Occluded  # , MarsAWSD
...
__image_datasets = {
    ...
    'msmt17': MSMT17,
    'occluded-Duke': OccludedDukeMTMCreID,
   'partial-reid':Paritial_REID, 
   'occluded-reid':Occluded_REID,
    'market1501-occluded':Market1501_Occluded,
    #'marsawsd': MarsAWSD
}
