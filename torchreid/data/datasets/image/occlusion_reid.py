...
class Occluded_REID(ImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        dataset_dir = '/export/livia/home/vision/mkiran/work/Person_Reid/Video_Person/Domain_Adapt/D-MMD/reid-data/Occluded_REID'
        self.root=osp.abspath(osp.expanduser(root))
        # self.dataset_dir = self.root
        data_dir = dataset_dir#osp.join(self.root, dataset_dir)
        ...
        train = self.process_dir(self.train_dir, relabel=True,is_train=True)
    ...
    def process_dir(self, dir_path, relabel=False,is_train=False, is_query=True):
