...
class Paritial_REID(ImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        self.root=osp.abspath(osp.expanduser(dataset_dir))
        # self.dataset_dir = self.root
        
        self.data_dir = self.root#osp.join(self.root, dataset_dir)
        print(self.data_dir)
        ...
        self.data_dir="/export/livia/home/vision/mkiran/work/Person_Reid/Video_Person/Domain_Adapt/D-MMD/reid-data/partial-reid"
    ...
    def process_dir(self, dir_path, relabel=False, is_query=True):
        ...
        #dir_path = "/export/livia/home/vision/mkiran/work/Person_Reid/Video_Person/Domain_Adapt/D-MMD/reid-data/partial-reid"
